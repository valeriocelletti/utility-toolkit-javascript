 ...
 */
  ...
  var CookieManager = {
    ...
    /**
     * Returns document.cookie if {@link areCookiesEnabled} is true, null otherwise
     ...
     * @returns {String} the cookie value or null if the cookie does not exists or if {@link areCookiesEnabled} is false.
     */
    ...
    removeCookie: function(key) { 
      ...
      var expireStr = "expires="+yesterday.toGMTString()+"; ";
